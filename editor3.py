...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow):
		...
		icon1 = QtGui.QIcon()
		icon1.addPixmap(QtGui.QPixmap("90doleva.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon2 = QtGui.QIcon()
		icon2.addPixmap(QtGui.QPixmap("90doprava.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon3 = QtGui.QIcon()
		icon3.addPixmap(QtGui.QPixmap("flip.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.actionFlip.setIcon(icon3)
		self.actionFlip.setObjectName("actionFlip")
		self.actionInvert = QtWidgets.QAction(MainWindow)
		icon4 = QtGui.QIcon()
		icon4.addPixmap(QtGui.QPixmap("invert.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon5 = QtGui.QIcon()
		icon5.addPixmap(QtGui.QPixmap("brightUP.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon6 = QtGui.QIcon()
		icon6.addPixmap(QtGui.QPixmap("brightDOWN.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		icon7 = QtGui.QIcon()
		icon7.addPixmap(QtGui.QPixmap("edges.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.actionEdges.setIcon(icon7)
		self.actionEdges.setObjectName("actionEdges")
		self.actionRGBtoRW = QtWidgets.QAction(MainWindow)
		icon8 = QtGui.QIcon()
		icon8.addPixmap(QtGui.QPixmap("RGBtoBW.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
	...
	def retranslateUi(self, MainWindow):
		...
		self.menuMenu.setTitle(_translate("MainWindow", "Soubor"))
